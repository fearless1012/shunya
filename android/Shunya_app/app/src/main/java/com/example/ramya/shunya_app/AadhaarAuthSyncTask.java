...
public class AadhaarAuthSyncTask extends AsyncTask<String, Void, AuthResponse> {
    ...
    public AadhaarAuthSyncTask(Context ctx, AuthCaptureData authCaptureData) {
    ...
    protected void onPostExecute(AuthResponse response) {
        ...
        if(response.isSuccess())
        {
            ...
            CharSequence text = "Form Filled using Aadhaar Fill";
