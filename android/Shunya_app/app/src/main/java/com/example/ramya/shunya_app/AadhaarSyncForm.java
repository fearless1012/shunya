...
public class AadhaarSyncForm extends AsyncTask<String, Void, AuthResponse> {
    ...
    public AadhaarSyncForm(Context ctx, AuthCaptureData authCaptureData) {
    ...
    protected void onPostExecute(AuthResponse response) {
        ...
        String msg = "Aadhaar Integration :  " + (response.isSuccess() ? "success" : "fail")
